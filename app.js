...
const longLabelMap = {
    ...
    'Ithaca': 'Ithaca, New York 🌨️',
    'Toms River': 'Toms River, New Jersey 👵',
    'Los Angeles': 'Los Angeles, California 😎',
    'Seattle': 'Seattle, Washington 🌧️',
    'Austin': 'Austin, Texas 🤠',
    'Houston': 'Houston, Texas 🤠.',
    'Berkeley': 'UC Berkeley 📚',
    'Cupertino': 'Cupertino, California 📱',
    'Chicago': 'Chicago, Illinois 🏙️',
    'Philadelphia': 'Philadelphia, Pennsylvania 🔔',
    'Pittsburgh': 'Pittsburgh, Pennsylvania ',
    'Ann Arbor': 'Ann Arbor, Michigan 🚗',
    'New York City': 'New York City, New York 🗽',
    'Outer Banks': 'The Outer Banks, North Carolina 🏖️',
    'San Diego': 'San Diego, California 🐬',
    'San Francisco': 'San Francisco, California 🌉',
    'Hamburg': 'Hamburg, Germany ⛵️',
    'Trier': 'Trier, Germany 🏰',
    'Amsterdam': 'Amsterdam, the Netherlands 🛶',
    'Imperial': 'Imperial College London 📚',
    'Oxford': 'Oxford, England 🏴󠁧󠁢󠁥󠁮󠁧󠁿',
    'Cambridge': 'Cambridge, England 🏴󠁧󠁢󠁥󠁮󠁧󠁿',
    'Berlin': 'Berlin, Germany',
    'Honolulu': 'Honolulu, Hawaii 🌺',
    'Washington, DC': 'Washington, DC 🏛️',
    'Radford': 'Radford, Virginia 🏡',
    'Virginia Beach': 'Virginia Beach ⚽️',
    'Rotterdam': 'Rotterdam, the Netherlands ⛴️',
    'Baltimore': 'Baltimore, Maryland 🦀',
    'Yosemite': 'Yosemite, California 🥾',
    'Lake Tahoe': 'Lake Tahoe, California ⛷️',
    'Richmond': 'Richmond, Virginia 🏘️',
        ...
        window.addEventListener('resize', onWindowResize, false);
            ...
            function animateCamera(cityName) {
                ...
                switch (currentIndex) {
                    ...
                    default:
                        durationMove = 3;
                        altitude = 0.35; // Fallback to a default altitude if needed
                }
