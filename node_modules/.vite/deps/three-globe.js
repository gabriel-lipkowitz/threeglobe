import {
  ...
  sum,
  turbo_default
} from "./chunk-NUOZZ27E.js";
import {
  BufferGeometryUtils_exports
} from "./chunk-4PIT7VYN.js";
import {
  BackSide,
  Box3,
  BoxGeometry,
...
function rgbToHsl(r, g, b) {
  ...
  g = bound01(g, 255);
  b = bound01(b, 255);
  var max3 = Math.max(r, g, b), min2 = Math.min(r, g, b);
  var h, s, l = (max3 + min2) / 2;
  if (max3 == min2) {
    h = s = 0;
  } else {
    var d = max3 - min2;
...
function diffArrays(prev, next, idAccessor) {
  ...
  if (!idAccessor) {
    ...
    var prevById = index3(prev, idAccessor, false);
    var nextById = index3(next, idAccessor, false);
...
function viewDigest(data, existingObjs, appendObj, removeObj, _ref7) {
  ...
  var pointsData = [].concat(_toConsumableArray2(enter), _toConsumableArray2(update17));
...
function o_midpoint(a, b, c) {
  ...
  b = cartesian(b);
  c = cartesian(c);
  const s = sign2(cartesianDot(cartesianCross(b, a), c));
...
function geoVoronoi(data) {
  ...
  v.triangles = function(data2) {
    ...
    return {
      type: "FeatureCollection",
      features: v.delaunay.triangles.map((tri, index4) => {
        tri = tri.map((i) => v.points[i]);
        tri.center = v.delaunay.centers[index4];
        return tri;
  ...
  var asm = (
    ...
    function(global2, env, buffer2) {
      ...
      function cd(a2, c2, d2) {
        ...
        do {
          if (!f2) {
            ...
            while (1) {
              if (_b2(f2, c2) | 0 ? _b2(f2 + 16 | 0, d2) | 0 : 0) {
                break;
              }
              g2 = b[f2 + 32 >> 2] | 0;
              f2 = (g2 | 0) == 0 ? f2 : g2;
      ...
      function dd(a2, c2, d2) {
        ...
        a2 = g2;
        while (1) {
          if (_b2(a2, c2) | 0 ? _b2(a2 + 16 | 0, d2) | 0 : 0) {
            f2 = 10;
            break;
          }
          a2 = b[a2 + 32 >> 2] | 0;
...
var LineSegmentsGeometry = class extends InstancedBufferGeometry {
  constructor() {
    ...
    const index4 = [0, 2, 1, 2, 3, 1, 2, 4, 3, 4, 5, 3, 4, 6, 5, 6, 7, 5];
...
var _ray;
var _lineWidth;
function getWorldSpaceHalfWidth(camera, distance, resolution2) {
...
var HexBinLayerKapsule = index({
  ...
  update: function update5(state) {
    ...
    var byH3Idx = index3(state.hexBinPointsData.map(function(d) {
...
function objMatch(obj, attrs) {
  ...
  return Object.entries(attrs).every(function(_ref3) {
    var _ref4 = _slicedToArray6(_ref3, 2), k = _ref4[0], v = _ref4[1];
  ...
  update: function update11(state) {
    ...
    threeDigest(state.labelsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        var _textObj$children = _slicedToArray6(textObj.children, 1), bbObj = _textObj$children[0];
        var color2 = colorAccessor(d);
        var opacity = colorAlpha(color2);
        ...
        bbObj.geometry = _construct(THREE$5.BoxGeometry, _toConsumableArray4(new THREE$5.Vector3().subVectors(textObj.geometry.boundingBox.max, textObj.geometry.boundingBox.min).toArray()));
...
var HtmlElementsLayerKapsule = index({
  ...
  update: function update13(state, changedProps) {
    ...
    var elemAccessor = index2(state.htmlElement);
...
var ObjectsLayerKapsule = index({
  ...
  update: function update14(state, changedProps) {
    ...
    var threeObjAccessor = index2(state.objectThreeObject);
...
var CustomLayerKapsule = index({
  ...
  update: function update15(state, changedProps) {
    ...
    var customObjectAccessor = index2(state.customThreeObject);
